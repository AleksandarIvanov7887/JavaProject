                    ...
                    <div class="col-lg-10">
                        ...
                        <div id="List_div"<%=Utils.isAdmin(request) ? " hidden=\"hidden\"" : ""%>>
                            ...
                            <div id="list_tasks_single" class="row col-lg-12" hidden="hidden">
                                ...
                                <div class="row col-lg-12 offset-top" style="width:945px; padding:25px 0px 0px 0px;">
                                    <div class="col-lg-2">
                                        <p class="text-right">Leave Comment</p>
                                    </div>
                                    <div class="col-lg-10">
                                        <textarea rows="5" class="form-control" id="add_comment_textarea" placeholder="Add Comment"></textarea>
                                    </div>
                                    <div class="col-sm-offset-10 col-sm-2" style="margin-top:20px; margin-bottom:20px;">
                                        <button class="btn btn-primary form-control" id="add_comment_btn">Add Comment</button>
                                    </div>
                                </div>
                                <div class="row offset-top">
                                    <label for="task_comments" class="control-label col-sm-2 text-right">Comments</label>
                                    <div class="col-lg-10" id="task_comments"></div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class='input-group date nov_date_picker' id="datetimepicker1">
                                                    <input type='text' class="form-control" id="task_final_date" placeholder="Due Date" onkeydown="return false;"/>
