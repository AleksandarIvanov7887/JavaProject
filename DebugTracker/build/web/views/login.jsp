...
<body>
    <div class="container my-jumbotron login-bg" style="margin-top:150px;">
        <form action="#" class="form-horizontal Clean" style="width:470px; text-align:center;">
            <img style="margin:15px 0px;" src="${pageContext.request.contextPath}/includes/images/logo.png">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <input class="btn btn-danger col-lg-10 help-block" style="width:100%;" type="button" id="login_btn" value="Login"/>
                </div>
            </div>
        </form>
    </div>
